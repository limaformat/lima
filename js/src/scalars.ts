 ...
 */
export const closingQuoteIndex = (s: string, singleQuoteEscape = true): number => {
 ...
 */
export const stripKeyQuotes = (s: string, strict = false, line = 0): string => {
