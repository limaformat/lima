...
- [ ] Lima References 2.0 — draft specification and 114-case draft corpus; the TypeScript implementation passes the complete draft suite, while other bindings remain on 1.0 ([spec](docs/lima-references-2.0-spec.md), [coverage](docs/corpus-design/coverage/references-2.0.md))
